...
export default function LandingPage() {
 const features = [
  ...
  },
  {
   ...
   title: "Time Tracking",
   description:
    "Track completion times and see your productivity patterns over time.",
  },
  {
   icon: Target,
   title: "Stay Focused",
   description:
    "Organize tasks by date and priority to maintain focus on what matters most.",
  },
 ];
     ...
     <div className="text-center space-y-8">
      <div className="space-y-4">
       <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight">
        Stunning Todos to <span className="text-primary">Make</span>
       </h1>
       <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
        Transform your productivity with our beautiful, intuitive todo
        application. Organize your life, track your progress, and achieve your
        goals with ease.
       </p>
      </div>
